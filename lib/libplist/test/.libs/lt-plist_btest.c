...
/* ./.libs/lt-plist_btest.c - temporary wrapper executable for .libs/plist_btest.exe
   Generated by libtool (GNU libtool) 2.4.6

   The plist_btest program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "plist_btest.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# plist_btest - temporary wrapper script for .libs/plist_btest.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The plist_btest program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"plist_btest.exe:plist_btest:$LINENO: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"plist_btest.exe:plist_btest:$LINENO: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"plist_btest.exe:plist_btest:$LINENO: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
