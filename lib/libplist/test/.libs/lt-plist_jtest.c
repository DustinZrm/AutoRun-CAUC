...
/* ./.libs/lt-plist_jtest.c - temporary wrapper executable for .libs/plist_jtest.exe
   Generated by libtool (GNU libtool) 2.4.6

   The plist_jtest program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C:\\Users\\123456\\Desktop\\ioslocation\\libplist\\src\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\Users\\123456\\Desktop\\ioslocation\\libplist\\src\\.libs;C:\\msys64\\mingw64\\lib;C:\\msys64\\mingw64\\bin;";
const char * TARGET_PROGRAM_NAME = "plist_jtest.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# plist_jtest - temporary wrapper script for .libs/plist_jtest.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The plist_jtest program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../src/libplist-2.0.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"plist_jtest.exe:plist_jtest:$LINENO: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"plist_jtest.exe:plist_jtest:$LINENO: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"plist_jtest.exe:plist_jtest:$LINENO: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
  ...
  fputs ("    PATH=/c/Users/123456/Desktop/ioslocation/libplist/src/.libs:/mingw64/lib:/m", f);
  fputs ("ingw64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/Users/123456/Desktop/ioslocation/libplist/src/.libs:$PATH\"\n", f);
  fputs ("\n", f);
