...
/* ./.libs/lt-inetcat.c - temporary wrapper executable for .libs/inetcat.exe
   Generated by libtool (GNU libtool) 2.4.6

   The inetcat program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C:\\Users\\123456\\Desktop\\ioslocation\\libusbmuxd\\src\\.libs;C:\\msys64\\mingw64\\lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C;C:\\msys64\\msys64\\mingw64\\lib;C;C:\\msys64\\msys64\\mingw64\\bin;C:\\Users\\123456\\Desktop\\ioslocation\\libusbmuxd\\src\\.libs;C:\\msys64\\mingw64\\lib;C:\\msys64\\mingw64\\bin;";
const char * TARGET_PROGRAM_NAME = "inetcat.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# inetcat - temporary wrapper script for .libs/inetcat.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The inetcat program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../src/libusbmuxd-2.0.la C:/msys64/mingw64/lib/libimobilede", f);
  fputs ("vice-glue-1.0.la /mingw64/lib/libplist-2.0.la C:/msys64/mingw64/lib/libplist-2.", f);
  fputs ("0.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"inetcat.exe:inetcat:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"inetcat.exe:inetcat:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"inetcat.exe:inetcat:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("slocation/libusbmuxd/src/.libs:/mingw64/lib:/mingw64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/Users/123456/Desktop/ioslocation/libusbmuxd/src/.libs:/mingw64/lib", f);
  fputs (":$PATH\"\n", f);
  fputs ("\n", f);
