...
/* ./.libs/lt-idevicesetlocation.c - temporary wrapper executable for .libs/idevicesetlocation.exe
   Generated by libtool (GNU libtool) 2.4.6

   The idevicesetlocation program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "idevicesetlocation.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# idevicesetlocation - temporary wrapper script for .libs/idevicesetlocation.ex", f);
  fputs ("e\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The idevicesetlocation program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("    echo \"idevicesetlocation.exe:idevicesetlocation:$LINENO: libtool wrapper (G", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"idevicesetlocation.exe:idevicesetlocation:$LINENO: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"idevicesetlocation.exe:idevicesetlocation:$LINENO: newargv[0]: $", f);
  ...
  fputs ("\n", f);
  fputs ("  program='idevicesetlocation.exe'\n", f);
