...
/* ./.libs/lt-idevicediagnostics.c - temporary wrapper executable for .libs/idevicediagnostics.exe
   Generated by libtool (GNU libtool) 2.4.6

   The idevicediagnostics program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "idevicediagnostics.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# idevicediagnostics - temporary wrapper script for .libs/idevicediagnostics.ex", f);
  fputs ("e\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The idevicediagnostics program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("    echo \"idevicediagnostics.exe:idevicediagnostics:$LINENO: libtool wrapper (G", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"idevicediagnostics.exe:idevicediagnostics:$LINENO: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"idevicediagnostics.exe:idevicediagnostics:$LINENO: newargv[0]: $", f);
  ...
  fputs ("\n", f);
  fputs ("  program='idevicediagnostics.exe'\n", f);
