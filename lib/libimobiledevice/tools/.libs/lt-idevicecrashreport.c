...
/* ./.libs/lt-idevicecrashreport.c - temporary wrapper executable for .libs/idevicecrashreport.exe
   Generated by libtool (GNU libtool) 2.4.6

   The idevicecrashreport program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "idevicecrashreport.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# idevicecrashreport - temporary wrapper script for .libs/idevicecrashreport.ex", f);
  fputs ("e\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The idevicecrashreport program cannot be directly executed until all the libt", f);
  fputs ("ool\n", f);
  ...
  fputs ("    echo \"idevicecrashreport.exe:idevicecrashreport:$LINENO: libtool wrapper (G", f);
  fputs ("NU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"idevicecrashreport.exe:idevicecrashreport:$LINENO: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"idevicecrashreport.exe:idevicecrashreport:$LINENO: newargv[0]: $", f);
  ...
  fputs ("\n", f);
  fputs ("  program='idevicecrashreport.exe'\n", f);
