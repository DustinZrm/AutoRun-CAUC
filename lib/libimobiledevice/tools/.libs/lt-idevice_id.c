...
/* ./.libs/lt-idevice_id.c - temporary wrapper executable for .libs/idevice_id.exe
   Generated by libtool (GNU libtool) 2.4.6

   The idevice_id program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "idevice_id.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# idevice_id - temporary wrapper script for .libs/idevice_id.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The idevice_id program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"idevice_id.exe:idevice_id:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"idevice_id.exe:idevice_id:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"idevice_id.exe:idevice_id:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
