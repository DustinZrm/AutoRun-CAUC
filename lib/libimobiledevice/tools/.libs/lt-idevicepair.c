...
/* ./.libs/lt-idevicepair.c - temporary wrapper executable for .libs/idevicepair.exe
   Generated by libtool (GNU libtool) 2.4.6

   The idevicepair program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "idevicepair.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# idevicepair - temporary wrapper script for .libs/idevicepair.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The idevicepair program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../src/libimobiledevice-1.0.la C:/msys64/mingw64/lib/libusb", f);
  fputs ("muxd-2.0.la /mingw64/lib/libimobiledevice-glue-1.0.la C:/msys64/mingw64/lib/lib", f);
  ...
  fputs ("    echo \"idevicepair.exe:idevicepair:$LINENO: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"idevicepair.exe:idevicepair:$LINENO: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"idevicepair.exe:idevicepair:$LINENO: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
