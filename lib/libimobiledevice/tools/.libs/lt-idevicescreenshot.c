...
/* ./.libs/lt-idevicescreenshot.c - temporary wrapper executable for .libs/idevicescreenshot.exe
   Generated by libtool (GNU libtool) 2.4.6

   The idevicescreenshot program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "idevicescreenshot.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# idevicescreenshot - temporary wrapper script for .libs/idevicescreenshot.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The idevicescreenshot program cannot be directly executed until all the libto", f);
  fputs ("ol\n", f);
  ...
  fputs ("    echo \"idevicescreenshot.exe:idevicescreenshot:$LINENO: libtool wrapper (GNU", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"idevicescreenshot.exe:idevicescreenshot:$LINENO: newargv[$lt_dump_ar", f);
  fputs ("gs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"idevicescreenshot.exe:idevicescreenshot:$LINENO: newargv[0]: $pr", f);
  ...
  fputs ("\n", f);
  fputs ("  program='idevicescreenshot.exe'\n", f);
