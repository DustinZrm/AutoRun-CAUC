...
/* ./.libs/lt-ideviceprovision.c - temporary wrapper executable for .libs/ideviceprovision.exe
   Generated by libtool (GNU libtool) 2.4.6

   The ideviceprovision program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "ideviceprovision.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ideviceprovision - temporary wrapper script for .libs/ideviceprovision.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The ideviceprovision program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("    echo \"ideviceprovision.exe:ideviceprovision:$LINENO: libtool wrapper (GNU l", f);
  fputs ("ibtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"ideviceprovision.exe:ideviceprovision:$LINENO: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"ideviceprovision.exe:ideviceprovision:$LINENO: newargv[0]: $prog", f);
  ...
  fputs ("\n", f);
  fputs ("  program='ideviceprovision.exe'\n", f);
