...
/* ./.libs/lt-idevicenotificationproxy.c - temporary wrapper executable for .libs/idevicenotificationproxy.exe
   Generated by libtool (GNU libtool) 2.4.6

   The idevicenotificationproxy program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C:\\Users\\123456\\Desktop\\ioslocation\\libimobiledevice\\src\\.libs;C:\\msys64\\mingw64\\lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C;C:\\msys64\\msys64\\mingw64\\lib;C;C:\\msys64\\msys64\\mingw64\\bin;C:\\Users\\123456\\Desktop\\ioslocation\\libimobiledevice\\src\\.libs;C:\\msys64\\mingw64\\lib;C:\\msys64\\mingw64\\bin;";
const char * TARGET_PROGRAM_NAME = "idevicenotificationproxy.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# idevicenotificationproxy - temporary wrapper script for .libs/idevicenotifica", f);
  fputs ("tionproxy.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The idevicenotificationproxy program cannot be directly executed until all th", f);
  fputs ("e libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../src/libimobiledevice-1.0.la C:/msys64/mingw64/lib/libimo", f);
  fputs ("biledevice-glue-1.0.la C:/msys64/mingw64/lib/libusbmuxd-2.0.la /mingw64/lib/lib", f);
  fputs ("imobiledevice-glue-1.0.la /mingw64/lib/libplist-2.0.la C:/msys64/mingw64/lib/li", f);
  fputs ("bplist-2.0.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"idevicenotificationproxy.exe:idevicenotificationproxy:$LINENO: libtoo", f);
  fputs ("l wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"idevicenotificationproxy.exe:idevicenotificationproxy:$LINENO: newar", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"idevicenotificationproxy.exe:idevicenotificationproxy:$LINENO: n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='idevicenotificationproxy.exe'\n", f);
  ...
  fputs ("    PATH=C:/msys64/mingw64/lib:C:/msys64/mingw64/bin:/c/Users/123456/Desktop/io", f);
  fputs ("slocation/libimobiledevice/src/.libs:/mingw64/lib:/mingw64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/Users/123456/Desktop/ioslocation/libimobiledevice/src/.libs:/mingw", f);
  fputs ("64/lib:$PATH\"\n", f);
  fputs ("\n", f);
