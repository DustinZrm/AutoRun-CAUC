...
/* ./.libs/lt-ideviceenterrecovery.c - temporary wrapper executable for .libs/ideviceenterrecovery.exe
   Generated by libtool (GNU libtool) 2.4.6

   The ideviceenterrecovery program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "ideviceenterrecovery.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ideviceenterrecovery - temporary wrapper script for .libs/ideviceenterrecover", f);
  fputs ("y.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The ideviceenterrecovery program cannot be directly executed until all the li", f);
  fputs ("btool\n", f);
  ...
  fputs ("    echo \"ideviceenterrecovery.exe:ideviceenterrecovery:$LINENO: libtool wrappe", f);
  fputs ("r (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"ideviceenterrecovery.exe:ideviceenterrecovery:$LINENO: newargv[$lt_d", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"ideviceenterrecovery.exe:ideviceenterrecovery:$LINENO: newargv[0", f);
  ...
  fputs ("\n", f);
  fputs ("  program='ideviceenterrecovery.exe'\n", f);
