...
/* ./.libs/lt-idevicebackup2.c - temporary wrapper executable for .libs/idevicebackup2.exe
   Generated by libtool (GNU libtool) 2.4.6

   The idevicebackup2 program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "idevicebackup2.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# idevicebackup2 - temporary wrapper script for .libs/idevicebackup2.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The idevicebackup2 program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"idevicebackup2.exe:idevicebackup2:$LINENO: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"idevicebackup2.exe:idevicebackup2:$LINENO: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"idevicebackup2.exe:idevicebackup2:$LINENO: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='idevicebackup2.exe'\n", f);
