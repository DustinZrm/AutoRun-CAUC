...
/* ./.libs/lt-idevicebackup.c - temporary wrapper executable for .libs/idevicebackup.exe
   Generated by libtool (GNU libtool) 2.4.6

   The idevicebackup program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "idevicebackup.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# idevicebackup - temporary wrapper script for .libs/idevicebackup.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The idevicebackup program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"idevicebackup.exe:idevicebackup:$LINENO: libtool wrapper (GNU libtool", f);
  fputs (") 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"idevicebackup.exe:idevicebackup:$LINENO: newargv[$lt_dump_args_N]: $", f);
  fputs ("lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"idevicebackup.exe:idevicebackup:$LINENO: newargv[0]: $progdir/$p", f);
  fputs ("rogram\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='idevicebackup.exe'\n", f);
