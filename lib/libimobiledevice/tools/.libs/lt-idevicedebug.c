...
/* ./.libs/lt-idevicedebug.c - temporary wrapper executable for .libs/idevicedebug.exe
   Generated by libtool (GNU libtool) 2.4.6

   The idevicedebug program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "idevicedebug.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# idevicedebug - temporary wrapper script for .libs/idevicedebug.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The idevicedebug program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"idevicedebug.exe:idevicedebug:$LINENO: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"idevicedebug.exe:idevicedebug:$LINENO: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"idevicedebug.exe:idevicedebug:$LINENO: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='idevicedebug.exe'\n", f);
