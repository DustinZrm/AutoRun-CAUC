...
/* ./.libs/lt-ideviceimagemounter.c - temporary wrapper executable for .libs/ideviceimagemounter.exe
   Generated by libtool (GNU libtool) 2.4.6

   The ideviceimagemounter program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "ideviceimagemounter.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ideviceimagemounter - temporary wrapper script for .libs/ideviceimagemounter.", f);
  fputs ("exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The ideviceimagemounter program cannot be directly executed until all the lib", f);
  fputs ("tool\n", f);
  ...
  fputs ("    echo \"ideviceimagemounter.exe:ideviceimagemounter:$LINENO: libtool wrapper ", f);
  fputs ("(GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"ideviceimagemounter.exe:ideviceimagemounter:$LINENO: newargv[$lt_dum", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"ideviceimagemounter.exe:ideviceimagemounter:$LINENO: newargv[0]:", f);
  ...
  fputs ("\n", f);
  fputs ("  program='ideviceimagemounter.exe'\n", f);
