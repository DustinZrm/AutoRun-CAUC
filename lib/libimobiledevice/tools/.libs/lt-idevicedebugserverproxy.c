...
/* ./.libs/lt-idevicedebugserverproxy.c - temporary wrapper executable for .libs/idevicedebugserverproxy.exe
   Generated by libtool (GNU libtool) 2.4.6

   The idevicedebugserverproxy program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "idevicedebugserverproxy.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# idevicedebugserverproxy - temporary wrapper script for .libs/idevicedebugserv", f);
  fputs ("erproxy.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The idevicedebugserverproxy program cannot be directly executed until all the", f);
  fputs (" libtool\n", f);
  ...
  fputs ("    echo \"idevicedebugserverproxy.exe:idevicedebugserverproxy:$LINENO: libtool ", f);
  fputs ("wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"idevicedebugserverproxy.exe:idevicedebugserverproxy:$LINENO: newargv", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"idevicedebugserverproxy.exe:idevicedebugserverproxy:$LINENO: new", f);
  ...
  fputs ("\n", f);
  fputs ("  program='idevicedebugserverproxy.exe'\n", f);
